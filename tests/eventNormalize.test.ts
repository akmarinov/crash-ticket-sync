...
describe("normalizeEvent", () => {
  it("maps nested Crashlytics export records into a flat event", () => {
    const event = normalizeEvent({
      ...
      exceptions: [{ type: "EXC_BAD_ACCESS", exception_message: "boom", frames: [{ library: "Kylee", symbol: "f()", file: "F.swift", line: 10, offset: 4, address: 7160 }] }],
      threads: [],
    ...
    expect(event.frames[0]).toMatchObject({ library: "Kylee", symbol: "f()", line: 10, address: "0x1bf8" });
